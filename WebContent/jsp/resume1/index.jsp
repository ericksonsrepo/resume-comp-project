  ...
  <p><div class="container">
		...
		<p>
        			...
        			<fieldset>
						...
						<p>
						<div class="row">
				<form action="<%=request.getContextPath()%>/Resume1" method="post">
                ...
                <div class="col-md-12 well text-center">
                    ...
                    <!--<form>-->
                      <!-- This is where you input your Education information -->	
						...
						<form action="<%=request.getContextPath()%>/Resume2" method="post">	
							<div class="form-group">
            ...
            <div class="col-xs-12">
                <div class="col-md-12 well text-center">
                    ...
                    <fieldset>
						...
						<form action="<%=request.getContextPath()%>/Resume3" method="post">
							<div class="form-group">
								<label>Company</label>
                ...
                <div class="col-md-12 well text-center">
                   ...
                   <p>
					<fieldset>
						...
						<form action="<%=request.getContextPath()%>/Resume4" method="post">	
						<div class="row">
							<div class="col-sm-6 form-group">
